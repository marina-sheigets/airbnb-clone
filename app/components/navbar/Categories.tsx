...
export const CATEGORIES = [
	...
	{ label: 'Countryside', icon: TbMountain, description: 'This property is in countryside' },
	...
	{ label: 'Arctic', icon: BsSnow, description: 'This property ' },
	{ label: 'Cave', icon: GiCaveEntrance, description: 'This property is in an cave ' },
